...
public class RegionController {
    ...
    public ResponseDto<?> hasUserVoted(@PathVariable Long weatherId) {
        Long userId = 1L;
        return ResponseDto.ok(voteHistoryService.checkUserVoting(userId, weatherId));
    }
    ...
    public ResponseDto<?> createVote(@PathVariable Long weatherId, @RequestBody VoteRequestDto voteRequestDto) {
        Long userId = 1L;
        voteHistoryService.createVote(weatherId, voteRequestDto, userId);
